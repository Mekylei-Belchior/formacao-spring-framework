...
public class Funcionario {
	...
	public void setUnidadeTrabalhos(List<UnidadeDeTrabalho> unidadesDeTrabalho) {
		this.unidadesDeTrabalho = unidadesDeTrabalho;
	}

	@Override
	public String toString() {
		return "Funcionario [id=" + id + ", nome=" + nome + ", CPF=" + cpf + ", Cargo=" + getCargo().getDescricao()
				+ ", dataContratacao=" + dataContratacao + ", Salário="+ salario + "]";
	}
